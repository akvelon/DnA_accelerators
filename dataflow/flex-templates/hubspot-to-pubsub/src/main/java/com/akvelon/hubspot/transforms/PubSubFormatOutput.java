...
/**
 * The {@link PubSubFormatOutput} wraps a String serializable messages with the {@link PubsubMessage}
 * class.
 */
public class PubSubFormatOutput extends PTransform<PCollection<String>, PDone> {

    private final CdapHubspotOptions options;

    public PubSubFormatOutput(CdapHubspotOptions options) {
